...
export default function DemoPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-primary/10 via-white to-brand-secondary/10 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      {/* Header */}
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center space-x-3 group">
              <div className="w-10 h-10 bg-gradient-to-br from-brand-primary to-brand-secondary rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                <svg className="w-6 h-6 text-gotsol-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              href="/"
              className="px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-brand-primary transition-colors font-medium"
            >
              ← Back to Home
            </Link>
          </div>
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-brand-primary/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-brand-primary text-sm font-bold">1</span>
                </div>
                <p>
              ...
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-brand-primary/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-brand-primary text-sm font-bold">2</span>
                </div>
                <p>
              ...
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-brand-primary/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-brand-primary text-sm font-bold">3</span>
                </div>
                <p>
              ...
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-brand-primary/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-brand-primary text-sm font-bold">4</span>
                </div>
                <p>
