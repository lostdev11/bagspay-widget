/**
 * BagsPay Embed Script
 * This script can be loaded from a CDN or served statically
 */
(function() {
  'use strict';
  ...
  function getWidgetUrl() {
    ...
    return 'https://widget.bagspay.com';
  }
  ...
  window.BagsPay = {
    init: function(config) {
      ...
      const messageHandler = function(event) {
        // Verify origin for security (in production, check against known domain)
